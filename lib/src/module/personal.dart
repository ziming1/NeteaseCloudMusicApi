...
Handler personal_fm = (query, cookie) {
  return request('POST', 'https://music.163.com/weapi/v1/radio/get', {}, crypto: Crypto.weapi, cookies: cookie);
};
...
Handler personalized_mv = (query, cookie) {
  return request('POST', 'https://music.163.com/weapi/personalized/mv', {}, crypto: Crypto.weapi, cookies: cookie);
};

// 推荐新歌
Handler personalized_newsong = (query, cookie) {
  return request('POST', 'https://music.163.com/weapi/personalized/newsong', {}, crypto: Crypto.weapi, cookies: cookie);
};
